...
const scaffoldConfig = {
  ...
  // Sepolia (11155111) is the target chain — see PLAN.md "Chain" for why.
  // During local contract work, temporarily swap to `chains.foundry` and run
  // `FORK_URL=sepolia yarn fork` so anvil carries real Uniswap v4 state.
  // The env var is required -- `yarn fork sepolia` silently forks mainnet.
